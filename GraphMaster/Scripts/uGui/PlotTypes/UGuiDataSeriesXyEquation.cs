...
namespace GraphMaster {
   ...
   */
  public class DataSeriesXyEquation : UGuiDataSeriesXy {
    protected float mResolution = 0.5f;
    protected string mEquation = "";

    /** \brief The plot's resolution of equated points. 
      * 
      *  Starting at the left of most value of the graph (min x) this value represents the step amount along the X asix for the equation to evaluate at.
      * 
    ...
    /** \brief The plot's equation. 
      ...
      *  Use "x" in your equation for the substitute value.
      *  
      *  Example: x * 4
      */
    ...
    public void evaluate() {
      ...
      data.Clear();
      for (float val = graph.RangeX.x; val <= graph.RangeX.y; val += mResolution) {
