...
namespace GraphMaster {
  public class SimpleDataExample : MonoBehaviour
  {
     Graph mGraph;
     UGuiDataSeriesXy mSeries1;
     ...
     void Awake ()
     {
        ...
        mSeries1 = mGraph.addDataSeries<UGuiDataSeriesXy>("Simple Plot 1", Color.green);
        mSeries1.PlotStyle = DataSeriesXy.Style.Line;
        mSeries1.PlotThickness = 3f;
        mSeries1.Data = data;
        
        mSeries1 = mGraph.addDataSeries<UGuiDataSeriesXy>("Simple Plot 2", Color.red);
        mSeries1.PlotStyle = DataSeriesXy.Style.Bar;
